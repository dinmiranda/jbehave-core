        ...
        public String transform(String storyAsText) {
            ...
            Formatter formatter = new Formatter() {
                ...
                private void writeNarrative(String description) {
                    ...
                    Matcher findingNarrative = compile(".*" + GherkinTransformer.this.keywords.narrative() + "(.*?)", DOTALL).matcher(description);
                ...
                private boolean writeNarrativeWithDefaultSyntax(final StringBuffer out, String narrative) {
                    boolean matches = false;
                    Matcher findingElements = compile(".*" + GherkinTransformer.this.keywords.inOrderTo() + "(.*)\\s*" + GherkinTransformer.this.keywords.asA() + "(.*)\\s*" + GherkinTransformer.this.keywords.iWantTo()
                    ...
                    if (findingElements.matches()) {
                        ...
                        out.append(GherkinTransformer.this.keywords.narrative()).append("\n");
                        out.append(GherkinTransformer.this.keywords.inOrderTo()).append(" ").append(inOrderTo).append("\n");
                        out.append(GherkinTransformer.this.keywords.asA()).append(" ").append(asA).append("\n");
                        out.append(GherkinTransformer.this.keywords.iWantTo()).append(" ").append(iWantTo).append("\n\n");
                        matches = true;
                    }
                    return matches;
                }
                ...
                private boolean writeNarrativeWithAlternativeSyntax(final StringBuffer out, String narrative) {
                    boolean matches = false;
                    Matcher findingElements = compile(".*" + GherkinTransformer.this.keywords.asA() + "(.*)\\s*" + GherkinTransformer.this.keywords.iWantTo() + "(.*)\\s*" + GherkinTransformer.this.keywords.soThat()
                            + "(.*)", DOTALL).matcher(narrative);
                    if (findingElements.matches()) {
                        ...
                        out.append(GherkinTransformer.this.keywords.asA()).append(" ").append(asA).append("\n");
                        out.append(GherkinTransformer.this.keywords.iWantTo()).append(" ").append(iWantTo).append("\n\n");
                        out.append(GherkinTransformer.this.keywords.soThat()).append(" ").append(soThat).append("\n");
                        matches = true;
                    }
                    return matches;
                }
